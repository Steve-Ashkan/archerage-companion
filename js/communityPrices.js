...
// Active for all users. All calls are fire-and-forget — local save
// always happens first regardless of network state.

import { getAuth, userHasRole } from './auth.js';
...
export function setupCommunityPrices() {
  // Hook into savePrice — logged-in users can contribute prices.
  window.__onPriceSaved = (itemName, price) => {
    submitPrice(itemName, price);
  };
