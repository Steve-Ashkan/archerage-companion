...
function renderGuide() {
  return `
    ...
    <p style="color:#8d99ab;font-size:13px;line-height:1.6;margin:0 0 16px;">
      Covers everything you need to know: free features, optional donations, scanners, and what to do first.
    ...
    <div style="background:#0f1923;border:1px solid #1e2d3d;border-radius:10px;padding:14px;margin-bottom:20px;">
      ...
      ${[
        ...
        'Free features and optional donations',
...
function renderSignIn() {
  ...
  return `
    ...
    <p style="color:#8d99ab;font-size:13px;line-height:1.6;margin:0 0 16px;">
      Sign in to earn ARC Points, submit prices and recipes, and keep your community profile synced.
    </p>
    <div style="display:flex;flex-direction:column;gap:6px;margin-bottom:20px;">
      ${[
        ...
        ['⭐', 'Use Net Worth, daily price feeds, and inventory import for free'],
      ].map(([icon, text]) => `
