    ...
    steps: [
      {
        ...
        labor: { skill: "Printing", baseEach: 50, qty: 10 },
        checks: [
      ...
      },
      {
        ...
        fixedLabor: { each: 500, qty: 1, note: "Ipnysh Altar" },
        checks: [
      ...
      },
      {
        ...
        fixedLabor: { each: 70, qty: 39, note: "Handicraft Kiln" },
        checks: [
      ...
      {
        id: "gold-ingots",
        title: "Make or Obtain 91 Gold Ingots",
        body: "Craft at a Smelter. On Rage, Gold Ingot uses 3 Gold Ore.",
        fixedLabor: { each: 14, qty: 91, note: "Smelter" },
        checks: [
      ...
      },
      {
        ...
        labor: { skill: "Handicrafts", baseEach: 2800, qty: 1 },
        checks: [
    ...
    steps: [
      {
        ...
        labor: { skill: "Alchemy", baseEach: 15, qty: 1700 },
        checks: [
      ...
      },
      {
        ...
        labor: { skill: "Alchemy", baseEach: 30, qty: 170 },
        checks: [
      ...
      {
        id: "archeum-ingots",
        title: "Make or Obtain 132 Archeum Ingots",
        body: "Craft at a Smelter. On Rage, Archeum Ingot uses 3 raw Archeum material.",
        fixedLabor: { each: 14, qty: 132, note: "Smelter" },
        checks: [
    ...
    steps: [
      {
        ...
        labor: { skill: "Alchemy", baseEach: 60, qty: 3 },
        checks: [
      ...
      },
      {
        ...
        fixedLabor: { each: 3, qty: 150, note: "30 Lunarite batch at Alchemy Table" },
        checks: [
      ...
      },
      {
        ...
        fixedLabor: { each: 1, qty: 900, note: "Alchemy Table" },
        checks: [
      ...
      },
      {
        ...
        fixedLabor: { each: 1, qty: 300, note: "Alchemy Table" },
        checks: [
      ...
      },
      {
        ...
        fixedLabor: { each: 1, qty: 100, note: "Alchemy Table" },
        checks: [
      ...
      },
      {
        ...
        fixedLabor: { each: 70, qty: 5, note: "Handicraft Kiln" },
        checks: [
      ...
      },
      {
        ...
        labor: { skill: "Alchemy", baseEach: 300, qty: 1 },
        checks: [
  ...
  "erenor-bow-scepter-staff": {
    ...
    steps: [
      ...
      },
      {
        ...
        labor: { skill: "Carpentry", baseEach: 2800, qty: 1 },
        checks: [
  ...
  "erenor-shield": {
    ...
    steps: [
      ...
      },
      {
        ...
        labor: { skill: "Weaponry", baseEach: 2800, qty: 1 },
        checks: [
    ...
    steps: [
      {
        ...
        body: "Craft at an Alchemy Table. Each Opaque Polish uses 3 Onyx Archeum Essence, 20 Narcissus, and 20 Azalea.",
        labor: { skill: "Alchemy", baseEach: 15, qty: 1700 },
        checks: [
          { id: "onyx", label: "Do you have 5,100 Onyx Archeum Essence?", item: "Onyx Archeum Essence", qty: 5100 },
      ...
      },
      {
        ...
        body: "Craft at an Alchemy Table. Each Rough Polish uses 5 Onyx Archeum Essence, 30 Lotus, 30 Oats, and 20 Antler Coral.",
        labor: { skill: "Alchemy", baseEach: 30, qty: 170 },
        checks: [
          { id: "onyx", label: "Do you have 850 Onyx Archeum Essence?", item: "Onyx Archeum Essence", qty: 850 },
          { id: "lotus", label: "Do you have 5,100 Lotus?", item: "Lotus", qty: 5100 },
          { id: "oats", label: "Do you have 5,100 Oats?", item: "Oats", qty: 5100 },
          { id: "antler-coral", label: "Do you have 3,400 Antler Coral?", item: "Antler Coral", qty: 3400 },
    ...
    steps: [
      {
        ...
        body: "Craft at an Alchemy Table. Each Opaque Polish uses 3 Onyx Archeum Essence, 20 Narcissus, and 20 Azalea.",
        labor: { skill: "Alchemy", baseEach: 15, qty: 7600 },
        checks: [
      ...
      },
      {
        ...
        body: "Craft at an Alchemy Table. Each Rough Polish uses 5 Onyx Archeum Essence, 30 Lotus, 30 Oats, and 20 Antler Coral.",
        labor: { skill: "Alchemy", baseEach: 30, qty: 760 },
        checks: [
      ...
      },
      {
        ...
        body: "Craft at a Regal Alchemy Table. Each Non-Stick Polish uses 9 Onyx Archeum Essence, 40 Chili Pepper, 40 Rosemary, 20 Pearl, and 5 Blueberry.",
        labor: { skill: "Alchemy", baseEach: 45, qty: 245 },
        checks: [
          { id: "onyx", label: "Do you have 2,205 Onyx Archeum Essence?", item: "Onyx Archeum Essence", qty: 2205 },
          { id: "chili-pepper", label: "Do you have 9,800 Chili Pepper?", item: "Chili Pepper", qty: 9800 },
          { id: "rosemary", label: "Do you have 9,800 Rosemary?", item: "Rosemary", qty: 9800 },
          { id: "pearl", label: "Do you have 4,900 Pearl?", item: "Pearl", qty: 4900 },
          { id: "blueberry", label: "Do you have 1,225 Blueberry?", item: "Blueberry", qty: 1225 },
      ...
      },
      {
        ...
        body: "Craft at a Smelter. Each Sturdy Ingot uses 8 Iron Ingots, 1 Copper Ingot, 1 Silver Ingot, and 1 Opaque Polish.",
        labor: { skill: "Metalwork", baseEach: 11, qty: 7600 },
        checks: [
      ...
      },
      {
        ...
        body: "Craft at a Smelter. Each Sunridge Ingot uses 10 Sturdy Ingots, 5 Mysterious Garden Powder, and 1 Rough Polish.",
        labor: { skill: "Metalwork", baseEach: 21, qty: 760 },
        checks: [
      ...
      },
      {
        ...
        body: "Craft at a Smelter. Each Blazing Sunridge Ingot uses 10 Sunridge Ingots, 9 Anya Ingots, 25 Dragon Essence Stabilizers, and 6 Flaming Logs.",
        labor: { skill: "Metalwork", baseEach: 106, qty: 76 },
        checks: [
      ...
      },
      {
        ...
        body: "Craft at a Printing Press. Each Armor Regrade Scroll uses 1 Moonpoint and 1 Blank Regrade Scroll.",
        labor: { skill: "Printing", baseEach: 50, qty: 70 },
        checks: [
      ...
      },
      {
        ...
        fixedLabor: { each: 500, qty: 7, note: "Ipnysh Altar" },
        checks: [
      ...
      },
      {
        ...
        checks: [
          { id: "moonlight-essence", label: "Do you have 595 Moonlight Archeum Essence?", item: "Moonlight Archeum Essence", qty: 595 },
          { id: "archeum-ingot", label: "Do you have 225 Archeum Ingots?", item: "Archeum Ingot", qty: 225 }
        ]
      },
      {
        id: "final-craft",
        title: "Craft at the Armorer's House",
        body: "Use the Equipment Designer's Workbench on the Armorer's House to craft each Erenor plate piece from its verified final recipe.",
        labor: { skill: "Metalwork", baseEach: 2800, qty: 7 },
        checks: [
          ...
          { id: "erenor-helm", label: "Erenor Helm crafted: 82 Moonlight, 11 Blazing Sunridge, 35 Archeum Ingots", manual: true },
          { id: "erenor-cuirass", label: "Erenor Cuirass crafted: 130 Moonlight, 13 Blazing Sunridge, 25 Archeum Ingots", manual: true },
          { id: "erenor-tassets", label: "Erenor Tassets crafted: 66 Moonlight, 9 Blazing Sunridge, 35 Archeum Ingots", manual: true },
          { id: "erenor-vambraces", label: "Erenor Vambraces crafted: 56 Moonlight, 9 Blazing Sunridge, 35 Archeum Ingots", manual: true },
          { id: "erenor-gauntlets", label: "Erenor Gauntlets crafted: 82 Moonlight, 11 Blazing Sunridge, 35 Archeum Ingots", manual: true },
          { id: "erenor-greaves", label: "Erenor Greaves crafted: 97 Moonlight, 12 Blazing Sunridge, 35 Archeum Ingots", manual: true },
          { id: "erenor-sabatons", label: "Erenor Sabatons crafted: 82 Moonlight, 11 Blazing Sunridge, 25 Archeum Ingots", manual: true }
        ]
      }
    ]
  },
  "full-leather-set": {
    ...
    steps: [
      ...
      },
      {
        ...
        labor: { skill: "Alchemy", baseEach: 60, qty: 245 },
        checks: [
      ...
      },
      {
        ...
        checks: [
          { id: "moonlight-essence", label: "Do you have 595 Moonlight Archeum Essence?", item: "Moonlight Archeum Essence", qty: 595 },
          { id: "archeum-ingot", label: "Do you have 235 Archeum Ingots?", item: "Archeum Ingot", qty: 235 }
        ]
      },
      {
        id: "final-craft",
        title: "Craft at the Armorer's House",
        body: "Use the Equipment Designer's Workbench on the Armorer's House to craft each Erenor leather piece from its verified final recipe.",
        labor: { skill: "Leatherwork", baseEach: 2800, qty: 7 },
        checks: [
          ...
          { id: "scrolls-ready", label: "Do you have 70 Armor Regrade Scrolls ready?", manual: true },
          { id: "ipnysh-blessings-ready", label: "Do you have 7 Ipnysh Moonlight Blessings ready?", manual: true },
          { id: "erenor-cap", label: "Erenor Cap crafted: 82 Moonlight, 11 Blazing Wind Spirit Leather, 35 Archeum Ingots", manual: true },
          { id: "erenor-jerkin", label: "Erenor Jerkin crafted: 130 Moonlight, 13 Blazing Wind Spirit Leather, 35 Archeum Ingots", manual: true },
          { id: "erenor-belt", label: "Erenor Belt crafted: 66 Moonlight, 9 Blazing Wind Spirit Leather, 35 Archeum Ingots", manual: true },
          { id: "erenor-guards", label: "Erenor Guards crafted: 56 Moonlight, 9 Blazing Wind Spirit Leather, 35 Archeum Ingots", manual: true },
          { id: "erenor-fists", label: "Erenor Fists crafted: 82 Moonlight, 11 Blazing Wind Spirit Leather, 25 Archeum Ingots", manual: true },
          { id: "erenor-breeches", label: "Erenor Breeches crafted: 97 Moonlight, 12 Blazing Wind Spirit Leather, 35 Archeum Ingots", manual: true },
          { id: "erenor-boots", label: "Erenor Boots crafted: 82 Moonlight, 11 Blazing Wind Spirit Leather, 35 Archeum Ingots", manual: true }
        ]
      }
    ]
  },
    ...
    steps: [
      {
        ...
        body: "Craft at an Alchemy Table. Each Small Root Pigment uses 3 Onyx Archeum Essence, 20 Clover, and 20 Rose.",
        labor: { skill: "Alchemy", baseEach: 15, qty: 7600 },
        checks: [
          { id: "onyx", label: "Do you have 22,800 Onyx Archeum Essence?", item: "Onyx Archeum Essence", qty: 22800 },
      ...
      },
      {
        ...
        body: "Craft at an Alchemy Table. Each Small Leaf Pigment uses 5 Onyx Archeum Essence, 30 Cornflower, 30 Lily, and 20 Green Coral.",
        labor: { skill: "Alchemy", baseEach: 30, qty: 760 },
        checks: [
          { id: "onyx", label: "Do you have 3,800 Onyx Archeum Essence?", item: "Onyx Archeum Essence", qty: 3800 },
      ...
      },
      {
        ...
        body: "Craft at a Regal Alchemy Table. Each Scented Petal Pigment uses 3 Dragon Essence Stabilizers, 50 Poppy, 50 Saffron, 10 Sparkling Shell Dust, and 10 Chestnut.",
        labor: { skill: "Alchemy", baseEach: 60, qty: 245 },
        checks: [
          { id: "dragon-stabilizer", label: "Do you have 735 Dragon Essence Stabilizers?", item: "Dragon Essence Stabilizer", qty: 735 },
      ...
      },
      {
        ...
        body: "Craft at a Weaving Loom. Each Beautifully Colored Fabric uses 10 Fabric and 1 Small Root Pigment.",
        labor: { skill: "Tailoring", baseEach: 10, qty: 7600 },
        checks: [
      ...
      },
      {
        ...
        body: "Craft at a Weaving Loom. Each Cloudspun Fabric uses 10 Beautifully Colored Fabric, 5 Mysterious Garden Powder, and 1 Small Leaf Pigment.",
        labor: { skill: "Tailoring", baseEach: 20, qty: 760 },
        checks: [
      ...
      },
      {
        ...
        body: "Craft at a Weaving Loom. Each Blazing Cloudspun Fabric uses 10 Cloudspun Fabric, 9 Anya Ingots, 25 Dragon Essence Stabilizers, and 6 Flaming Logs.",
        labor: { skill: "Tailoring", baseEach: 100, qty: 76 },
        checks: [
      ...
      },
      {
        ...
        checks: [
          { id: "moonlight-essence", label: "Do you have 595 Moonlight Archeum Essence?", item: "Moonlight Archeum Essence", qty: 595 },
          { id: "archeum-ingot", label: "Do you have 205 Archeum Ingots?", item: "Archeum Ingot", qty: 205 }
        ]
      },
      {
        id: "final-craft",
        title: "Craft at the Armorer's House",
        body: "Use the Equipment Designer's Workbench on the Armorer's House to craft each Erenor cloth piece from its verified final recipe.",
        labor: { skill: "Tailoring", baseEach: 2800, qty: 7 },
        checks: [
          ...
          { id: "scrolls-ready", label: "Do you have 70 Armor Regrade Scrolls ready?", manual: true },
          { id: "ipnysh-blessings-ready", label: "Do you have 7 Ipnysh Moonlight Blessings ready?", manual: true },
          { id: "erenor-hood", label: "Erenor Hood crafted: 82 Moonlight, 11 Blazing Cloudspun Fabric, 25 Archeum Ingots", manual: true },
          { id: "erenor-shirt", label: "Erenor Shirt crafted: 130 Moonlight, 13 Blazing Cloudspun Fabric, 25 Archeum Ingots", manual: true },
          { id: "erenor-sash", label: "Erenor Sash crafted: 66 Moonlight, 9 Blazing Cloudspun Fabric, 35 Archeum Ingots", manual: true },
          { id: "erenor-sleeves", label: "Erenor Sleeves crafted: 56 Moonlight, 9 Blazing Cloudspun Fabric, 35 Archeum Ingots", manual: true },
          { id: "erenor-gloves", label: "Erenor Gloves crafted: 82 Moonlight, 11 Blazing Cloudspun Fabric, 35 Archeum Ingots", manual: true },
          { id: "erenor-pants", label: "Erenor Pants crafted: 97 Moonlight, 12 Blazing Cloudspun Fabric, 25 Archeum Ingots", manual: true },
          { id: "erenor-shoes", label: "Erenor Shoes crafted: 82 Moonlight, 11 Blazing Cloudspun Fabric, 25 Archeum Ingots", manual: true }
        ]
      }
    ]
  }
...
const recipes = [
  ...
  },
  {
    ...
    items: [
      ...
      { item: "Chili Pepper", qty: 9800 },
      { item: "Rosemary", qty: 9800 },
      { item: "Pearl", qty: 4900 },
      { item: "Blueberry", qty: 1225 },
      { item: "Iron Ingot", qty: 60800 },
      { item: "Copper Ingot", qty: 7600 },
      { item: "Anya Ingot", qty: 684 },
      { item: "Moonlight Archeum Essence", qty: 595 },
      { item: "Archeum Ingot", qty: 225 },
      ...
      { item: "Onyx Archeum Essence", qty: 28805 },
...
function renderStepLabor(step) {
  if (step.fixedLabor) {
    const each = Number(step.fixedLabor.each || 0);
    const qty = Number(step.fixedLabor.qty || 1);
    return `
      <div style="font-size:12px;color:#93c5fd;margin-top:5px;line-height:1.45;">
        Labor: ${each.toLocaleString()} each / ${(each * qty).toLocaleString()} total
        <span style="color:#8d99ab;">(${escapeHtml(step.fixedLabor.note || "fixed craft labor")})</span>
      </div>
    `;
  }
