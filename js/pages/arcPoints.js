...
const REWARDS = [
  {
    ...
    label: 'Market Scout Title',
    description: 'Unlock a cosmetic title for your profile and contributor listings.',
    baseCost: 250,
    icon: '[T]',
    category: 'title',
    proOnly: false,
  ...
  {
    id: 'badge_price_contributor',
    label: 'Price Contributor Badge',
    description: 'Show a small badge that marks you as a market data contributor.',
    baseCost: 400,
    icon: '[B]',
    category: 'badge',
    proOnly: false,
  ...
  {
    id: 'theme_erenor_gold',
    label: 'Erenor Gold Theme',
    description: 'Unlock an optional visual theme for the app.',
    baseCost: 750,
    icon: '[C]',
    category: 'theme',
    proOnly: false,
  ...
  {
    id: 'banner_daru_market',
    label: 'Daru Market Banner',
    description: 'Unlock a cosmetic banner background for your Home profile card.',
    baseCost: 1000,
    icon: '[P]',
    category: 'banner',
    proOnly: false,
  ...
  {
    id: 'wall_contributor_pin',
    label: 'Contributor Wall Pin',
    description: 'Pin your IGN on the in-app contributor wall for a month.',
    baseCost: 1500,
    icon: '[W]',
    category: 'wall',
    proOnly: false,
  ...
  return `
      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:16px;margin-bottom:${currentTitle || nextTier ? '16px' : '0'};">
        <div>
          ...
          <p style="margin:0;color:#566174;font-size:13px;">
            Earn points by contributing to the app. Redeem them for cosmetic app unlocks and community recognition.
          </p>
        </div>
        <div style="text-align:right;">
    ...
    <div class="card" style="margin-bottom:16px;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;flex-wrap:wrap;gap:8px;">
        ...
        <span style="font-size:12px;color:#566174;">Cosmetic only. No paid access, no gameplay advantage.</span>
      </div>

      ${renderRewardSection('Profile Titles', 'title', points, userPro)}
      ${renderRewardSection('Profile Badges', 'badge', points, userPro)}
      ${renderRewardSection('App Themes', 'theme', points, userPro)}
      ${renderRewardSection('Profile Banners', 'banner', points, userPro)}
      ${renderRewardSection('Community Recognition', 'wall', points, userPro)}
    </div>
...
window.arcRedeem = function(rewardId) {
  ...
  modal.innerHTML = `
    <div style="background:#1a2535;border:1px solid #2a3a52;border-radius:12px;
      ...
      <h3 style="margin:0 0 16px;color:#eef2f7;">Confirm Unlock</h3>
      <div style="background:#0f1923;border:1px solid #1e2d3d;border-radius:8px;padding:14px;margin-bottom:16px;">
        ...
        <div style="font-size:12px;color:#8d99ab;margin-top:10px;">This creates an unlock request for Ashkan to fulfill.</div>
      ...
      <div style="display:flex;justify-content:space-between;align-items:center;
        ...
        <span style="color:#94a3b8;">ARC Points spent</span>
...
window.arcConfirmRedeem = async function(rewardId, cost) {
  ...
  if (result?.ok) {
    ...
    alert('Unlock request failed: ' + (result?.error || 'Unknown error'));
  }
};
