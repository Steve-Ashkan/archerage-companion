...
try {
  ...
  contextBridge.exposeInMainWorld('electronAPI', {
    ...
    donationsGetPublic:   (month) => ipcRenderer.invoke('donations-get-public', { month }),
    donationsAdminAdd:    (opts)  => ipcRenderer.invoke('donations-admin-add', opts),
    donationsAdminDelete: (id)    => ipcRenderer.invoke('donations-admin-delete', { id }),
    ...
    onUpdateProgress:  (cb) => ipcRenderer.on('update-download-progress', (e, info) => cb(info)),
